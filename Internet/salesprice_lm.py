...
for a in 1000,2000,3000:
    pred, cb, fvals = predict_functional(result, "year", values={"LIVING_SQUARE_FEET": a, "age": 10}, 
                                         summaries={"LAND_SQUARE_FOOTAGE": np.median})
    plt.plot(fvals, pred, '-', label=str(a))
